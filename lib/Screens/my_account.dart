  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: SingleChildScrollView(
                  ...
                  Expanded(
                      child: Padding(
                          ...
                          child:
                            ...
                            Text("Krishna Softweb", style: TextStyle(fontSize: 17, color: Colors.white, fontWeight: FontWeight.bold)),
                            SizedBox(height: 3),
                            Text("krishnasoftweb@gmail.com",
                                style: TextStyle(fontSize: 13, color: Colors.white60, fontWeight: FontWeight.bold)),
                            SizedBox(height: 3),
                            Text("+91-8758431417", style: TextStyle(fontSize: 13, color: Colors.white60, fontWeight: FontWeight.bold))
                          ]))),
                  IconButton(
          ...
          Divider(height: 0, color: Colors.grey),
          ListTile(title: Text("Logout", style: TextStyle(fontWeight: FontWeight.w500, fontSize: 14)), onTap: () {}),
          Divider(height: 0, color: Colors.grey)
        ])));
  }
    ...
    return Expanded(
        child: FlatButton(
            ...
            child: Row(children: [
              ...
              SizedBox(width: 10),
              Expanded(
                  child: Text(label, style: TextStyle(color: Colors.white, fontSize: 12), maxLines: 2, overflow: TextOverflow.ellipsis))
            ])));
  }
}
