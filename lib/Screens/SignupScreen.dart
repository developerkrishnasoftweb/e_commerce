  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: SingleChildScrollView(
            ...
            child: Column(mainAxisSize: MainAxisSize.max, crossAxisAlignment: CrossAxisAlignment.start, children: <Widget>[
              SizedBox(height: 15),
              Text("Please enter your detail", style: TextStyle(fontSize: 14.sp, fontWeight: FontWeight.bold, color: Colors.black)),
              SizedBox(height: 15),
              TextField(
                ...
                Expanded(
                    child: RichText(
                        ...
                        text: TextSpan(
                            ...
                            style: TextStyle(color: Colors.blueGrey, fontSize: 12.sp),
                            children: [TextSpan(text: '36 sec', style: TextStyle(fontSize: 12.sp, fontWeight: FontWeight.bold))]))),
              ...
              Container(
                  ...
                  child: FlatButton(
                      ...
                      child: Text("Verify", style: TextStyle(fontSize: 17, fontWeight: FontWeight.bold, color: Colors.white)),
