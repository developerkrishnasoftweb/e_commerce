...
class _FilterListState extends State<FilterList> {
  ...
  List<Map<String, dynamic>> filteredList = [
    ...
    {
      "filterTitle": "PRICE",
      "filterList": ["Above 1000", "Above 2000", "Above 3000", "Above 4000", "Above 5000"]
    },
    {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          title: Text("Filters", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20, color: Colors.white)),
          centerTitle: false,
            ...
            Container(
                ...
                child: ListView.builder(
                    ...
                    itemBuilder: (_, i) => ListTile(
                        ...
                        onTap: () => setState(() => filterData = filteredList[i]["filterList"])),
