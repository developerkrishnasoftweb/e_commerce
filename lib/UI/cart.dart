                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                            Text("Items Total", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.grey),),
                            Text("\$125.00", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold),),
                          ],),
                          SizedBox(height: 5,),
                          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                            Text("Shipping Charge*", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.grey),),
